...
import com.hyphenate.chatuidemo.activity.MainActivity;
import com.hyphenate.chatuidemo.activity.VideoCallActivity;
import com.hyphenate.chatuidemo.activity.VoiceCallActivity;
...
public class DemoHXSDKHelper extends HXSDKHelper{
    ...
    protected void initEventListener() {
        ...
        EMClient.getInstance().chatroomManager().addChatRoomChangeListener(new EMChatRoomChangeListener(){
            private final static String ROOM_CHANGE_BROADCAST = "hyphenate.demo.chatroom.changeevent.toast";
